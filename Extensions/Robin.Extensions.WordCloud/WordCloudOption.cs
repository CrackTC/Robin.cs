...
public record CloudOption
{
    ...
    [JsonPropertyName("stroke_ratio")]
    public float StrokeRatio { get; set; }

    [JsonPropertyName("stroke_colors")]
    ...
    [JsonPropertyName("background_image_blur")]
    public int BackgroundImageBlur { get; set; }

    [JsonPropertyName("background_image_url")]
    public string? BackgroundImageUrl { get; set; }

    [JsonPropertyName("background_size_limit")]
    public int? BackgroundSizeLimit { get; set; }
