...
internal class OneBotMessageInfo
{
    ...
    [JsonPropertyName("message_type")] public required OneBotMessageType MessageType { get; set; }
    ...
    public MessageInfo ToMessageInfo(OneBotMessageConverter converter) => new(
        Time,
