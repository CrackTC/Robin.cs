...
internal class SendGroupPoke
    : IOneBotRequestConverter<Abstractions.Operation.Requests.SendGroupPoke>
{
    public OneBotRequest ConvertToOneBotRequest(
        Abstractions.Operation.Requests.SendGroupPoke request,
