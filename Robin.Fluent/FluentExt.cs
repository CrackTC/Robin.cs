...
public static class FluentExt
{
    ...
    public static EventTunnelBuilder<TEvent, EventContext<TEvent>> OnCommand<TEvent>(
        this EventTunnelBuilder<TEvent, EventContext<TEvent>> builder,
        string command,
        char prefix = '/'
    ) where TEvent : MessageEvent =>
    ...
    public static EventTunnelBuilder<TEvent, (EventContext<TEvent> EventContext, string Text)> OnText<TEvent>(
        this EventTunnelBuilder<TEvent, EventContext<TEvent>> builder
    ) where TEvent : MessageEvent =>
        builder
    ...
    public static EventTunnelBuilder<TEvent, (EventContext<TEvent> EventContext, string MessageId)> OnReply<TEvent>(
        this EventTunnelBuilder<TEvent, EventContext<TEvent>> builder
    ) where TEvent : MessageEvent =>
        builder
    ...
    public static EventTunnelBuilder<TEvent, (EventContext<TEvent> EventContext, Match Match)> OnRegex<TEvent>(
        this EventTunnelBuilder<TEvent, EventContext<TEvent>> builder,
        Regex regex
    ) where TEvent : MessageEvent =>
        builder
    ...
    public static EventTunnelBuilder<GroupPokeEvent, EventContext<GroupPokeEvent>> OnPokeSelf(
        this EventTunnelBuilder<GroupPokeEvent, EventContext<GroupPokeEvent>> builder,
        long selfUin
    ) =>
        builder
