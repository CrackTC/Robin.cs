...
{
    [JsonPropertyName("content")] public required OneBotKeyboardContent Content { get; set; }
    public OneBotSegment FromSegmentData(SegmentData data, OneBotMessageConverter converter)
    {
        ...
        {
            Rows = d!.Content.Rows.Select(row => new OneBotKeyboardRow
            {
                Buttons = row.Buttons.Select(button => new OneBotKeyboardButton
                {
                    Id = button.Id,
...
{
    [JsonPropertyName("rows")] public required List<OneBotKeyboardRow> Rows { get; set; }
}

[Serializable]
internal class OneBotKeyboardRow
{
    [JsonPropertyName("buttons")] public required List<OneBotKeyboardButton> Buttons { get; set; }
}
...
internal class OneBotKeyboardButton
{
    ...
    [JsonPropertyName("render_data")] public required OneBotKeyboardRenderData RenderData { get; set; }
    [JsonPropertyName("action")] public required OneBotKeyboardAction Action { get; set; }
}
...
internal class OneBotKeyboardRenderData
{
    ...
    [JsonPropertyName("visited_label")] public required string VisitedLabel { get; set; }
    [JsonPropertyName("style")] public required int Style { get; set; }
}
...
internal class OneBotKeyboardAction
{
    ...
    [JsonPropertyName("permission")] public required OneBotKeyboardPermission Permission { get; set; }
    [JsonPropertyName("unsupport_tips")] public required string UnsupportedTips { get; set; }
...
{
    [JsonPropertyName("type")] public required int Type { get; set; }
    [JsonPropertyName("specify_role_ids")] public List<string>? RoleIds { get; set; }
    [JsonPropertyName("specify_user_ids")] public List<string>? UserIds { get; set; }
}
